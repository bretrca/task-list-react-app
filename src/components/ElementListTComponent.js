...
function ElementListComponent({id,description,setInputValue,handlerUpdate}) {
    //hooks
    ...
    function handleSaveEdit(e){
        ...
        return (<div  className="ElementListComponent">
        {
            isEditing?
        ...
        <div className ="Buttons">
            {
                isEditing?
                (<>
                    <button onClick = {handleSaveEdit} onSubmit = {toggleEditItem} >Save</button>
